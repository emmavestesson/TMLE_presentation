...
-   Patients have remote consultations might be different to those that have face-to-face consultations \## Many different types of causal inference
...
1.  The stable treatment assumption (SUTVA) the treatment status of any individual does not affect the potential outcomes of other individuals
...
-   Estimate the conditional probability of being exposed
